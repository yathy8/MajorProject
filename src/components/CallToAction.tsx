  ...
  return (
    <div className="bg-black text-white py-[72px] sm:py-24" ref={containerRef}>
      ...
      <Image src={EmojiImage} alt="emoji" className="absolute -top-[120px] right-[calc(100%+30px)]" />
        ...
        <p className="text-xl text-white/72  mt-5">Celebrate the joy of accomplishment with an app designed to track your progress and motivate you.</p>
        <form className="mt-10 flex flex-col gap-2.5 max-w-sm mx-auto sm:flex-row">
          <input type="email" placeholder="email address" className="h-12 bg-white/20 rounded-lg px-5 font-medium placeholder:text-[#9CA3AF] sm:flex-1"/>
