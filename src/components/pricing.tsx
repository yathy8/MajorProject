    ...
    <div>
      ...
      <div className="max-w-sm mx-auto grid gap-6 lg:grid-cols-3 items-start lg:max-w-none">
        ...
        <PricingTab
          ...
          planDescription="A simple yet effective UI to help individuals stay on track with their goals and progress."
          features={[
            'Clean and responsive landing page',
            'Progress tracking for key milestones',
        ...
        <PricingTab
          ...
          planDescription="Enhanced features for individuals looking for more personalised and interactive growth experience."
          features={[
            'Everything in basic plan',
            'Customizable goal tracker',
            'Weekly insights and reflection section',
            'Integration Google calender',
        ...
        <PricingTab
          ...
          planDescription="A full-featured experience designed to maximise productivity."
          features={[
            'Everything in Pro plan',
            'AI-powered goal suggesstion',
            'Data visualisation for long term',
            'Social sharing options',
            'Custome themes and Branding',
            'Bonus:exclusive access to expert growth webinars',
          ]} />
