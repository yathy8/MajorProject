...
export const Hero = () => {
  return (
    ...
    <div className="container relative">
      ...
      <h1 className='text-7xl sm:text-9xl font-bold tracking-tightner text-center inline-flex'>Nova UI</h1>
      ...
      <p className='text-xl text-center mt-8 max-w-md'>Embrace your journey with an app that helps you stay on track, inspires continuous growth, and celebrates every milestone along the way.</p>
      </div>
      <div className="flex justify-center mt-8">
