  ...
  return (
    <div className="flex flex-col justify-center h-full items-center relative">
      ...
      <div className="text-left p-6 mt-4">
        ...
        <p className="text-gray-400 text-lg">Integrate AWS and use seamlessly.</p>
      </div>
    </div>
  );
};
        ...
        <CardWithEffect>
          <div className="flex flex-col justify-between h-full">
            ...
            <div className="text-left p-6 mt-4">
              ...
              <p className="text-white/70 text-lg">Fly through your tasks with rapid-fire keyboard shortcuts for everything.</p>
            </div>
          </div>
        </CardWithEffect>
